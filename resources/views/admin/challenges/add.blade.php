                ...
                <div class="col-md-8 ps-1 pe-1">
                    <div class="card border-primary mb-2">
                        <div class="card-header bg-light">
                            <p class="m-0">
                                <a href="{{route('ql_baiviet.index')}}">Danh sách challenges</a> /
                            </p>
                            <h3 class="inline">Tạo challenges mới</h3>
                        </div>
                        <div class="card-body">
                            {{ csrf_field() }}
                            <div class="form-outline mb-3">
                                <input type="text" id="title" class="form-control @error('title') is-invalid @enderror"
                                    ...
                                    required />
                                <label class="form-label" for="formtitlehelp">Tên challenges</label>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="status" id="status"
                                        value="1" checked>
                                    <label class="custom-control-label" for="status">Công khai challenges này</label>
                                </div>
                            </div>
